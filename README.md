...
- The database layer currently relies on score helper functions (`NUMBER_OF_GAMES`, `NUMBER_OF_SETS`, `NUMBER_OF_TIE_BREAKS`) plus `PLAYER_WIN_FACTOR(...)` as the self-contained source of truth for TA-calibrated CODEX matchup probability.

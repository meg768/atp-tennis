...
`PLAYER_WIN_FACTOR.sql` is the self-contained source of truth for GPT matchup
...
`PLAYER_ODDS.sql` returns two rows of GPT decimal odds for a matchup, one row per

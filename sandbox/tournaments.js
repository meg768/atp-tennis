...
async function addEventIds(tournaments) {
...
async function addAtpIds(tournaments) {
...
async function main() {
	...
	try {
		tournaments = await addEventIds(tournaments);
		tournaments = await addAtpIds(tournaments);
	} finally {
